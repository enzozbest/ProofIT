...
class TestSeedingService {
    ...
    @Test
    fun `seedComponents should process component library on success path`() = runBlocking {
    ...
    @Test
    fun `seedComponents should handle exceptions from Seeder`() = runBlocking {
    ...
    @Test
    fun `seedComponents should handle missing resource directory`() = runBlocking {
