...
class WebContainerTest {
    ...
    fun `test parsePrototype returns input unchanged`() {
        ...
        val result =
            webContainer::class.java
                .getDeclaredMethod("parsePrototype", String::class.java)
                .apply {
                    isAccessible = true
    ...
    @Test
    fun `test webcontainer route with valid id`() =
        testApplication {
            application {
    ...
    @Test
    fun `test webcontainer route with missing id`() =
        testApplication {
            application {
                routing {
                    with(webContainer) {
    ...
    @Test
    fun `test webcontainer route with blank id`() =
        testApplication {
            application {
                routing {
                    with(webContainer) {
    ...
    @Test
    fun `test getValidPrototypeIdOrRespond with valid id`() =
        testApplication {
            application {
                routing {
                    get("/test/{id}") {
    ...
    @Test
    fun `test getValidPrototypeIdOrRespond with missing id`() =
        testApplication {
            application {
                routing {
                    get("/test") {
    ...
    @Test
    fun `test getValidPrototypeIdOrRespond with blank id`() =
        testApplication {
            application {
                routing {
                    get("/test/{id}") {
