/**
   ...
   */
export const normaliseFiles = (files: Record<string, any>): Record<string, any> => {
    ...
    Object.keys(files).forEach(path => {
      ...
      if (fileData.contents) {
        ...
        if (path.includes('/')) {
          ...
          console.log(`Adding file "${fileName}" to directory with content length: ${fileData.contents.length} chars`);
